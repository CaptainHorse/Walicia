...
using namespace gl;
// HACK: Manually defined cuz glbinding doesn't give these normally, we are targeting 3.3+ so this works out anyways
...
bool ImGui_ImplOpenGL3_Init(const char* glsl_version)
{
    ...
    if (major == 0 && minor == 0)     {
        ...
        auto _ = sscanf(gl_version, "%d.%d", &major, &minor);
    }
